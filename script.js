...
xist.node = (function () {
  let node = function (options, data) {
    ...
    //     type: "x,y",
    //     edgeResistance: 0.65,
    //     bounds: this.tree.view.container,
    //     onPress: function (e) {
    //       e.stopPropagation();
    ...
    //       let nodes = self.tree.grid.search(xist.node.box);
    //       let i = nodes.length;

    //       while (--i > -1) {
    //         //dropTarget all nodes expect self
    //         if (nodes[i].id == self.id) continue;
    //         TweenLite.set(nodes[i], { className: "+=dropTarget" });
    //       }

    //       //remove dropTarget class from old targets
    //       let targets = mkr.queryAll(".node.dropTarget");
    //       i = targets.length;
    //       while (--i > -1) {
    //         let target = targets[i];
    //         if (nodes.indexOf(target) < 0)
    //           TweenMax.set(target, { className: "-=dropTarget" });
    //       }
    //     },
  ...
  node.prototype = {
    ...
    update: function () {
      ...
      // TweenMax.set(mkr.query(".born .lbl", this.view), {
      //   autoAlpha: this.data.dob || this.data.pob,
      // });
      // TweenMax.set(mkr.query(".born .date", this.view), {
      //   text: this.data.dob,
      // });
      // TweenMax.set(mkr.query(".born .place", this.view), {
      //   text: (this.data.dob ? ", " : "") + this.data.pob,
      // });
      // TweenMax.set(mkr.query(".died .lbl", this.view), {
      //   autoAlpha: this.data.dod || this.data.pod,
      // });
      // TweenMax.set(mkr.query(".died .date", this.view), {
      //   text: this.data.dod,
      // });
      // TweenMax.set(mkr.query(".died .place", this.view), {
      //   text: (this.data.dod ? ", " : "") + this.data.pod,
      // });
    },
  };
...
xist.iTree = (function () {
  let iTree = function (data, options) {
    ...
    //   "div",
    //   {
    //     attr: { id: "addNode", class: "btn btn-primary" },
  ...
  iTree.prototype = {
    ...
    onTreeResize: function () {
      ...
      // console.log("momX: " + momX);
      // console.log("momY: " + momY);
      // console.log("mom.height: " + this.mom.height);
      // console.log("mom.width: " + this.mom.width);
      // console.log("mom.nodeW: " + this.mom.nodeW);
      // console.log("dadX: " + dadX);
      // console.log("dadY: " + dadY);
      // console.log("dad.height: " + this.dad.height);
      // console.log("dad.height: " + this.dad.height);
      // console.log("dad.nodeW: " + this.dad.nodeW);
...
let data = [
  ...
  //           dob: "3.26.1892",
  //           dod: "4.4.1972",
  //           children: [{ name: "Emma Luders" }, { name: "Johan Martens" }],
  //         },
  //       ],
  //     },
  //     {
  ...
  //           dob: "5.7.1882",
  //           dod: "4.30.1959",
  //           children: [{ name: "Anna Siebert" }, { name: "Gustav Rempel" }],
  //         },
  //         {
  //           name: "John Winzer",
  //           dob: "3.23.1887",
  //           dod: "7.26.1982",
  //           children: [{ name: "Sarah Graham" }, { name: "Julius Winzer" }],
  //         },
  //       ],
  //     },
  //   ],
  ...
  //           dob: "1.2.1896",
  //           pob: "Milwaukee, WI",
  //           children: [{ name: "Josephine" }, { name: "Henry Heiser" }],
  //         },
  //         {
  //           name: "Simon Rosenburg",
  //           dob: "9.5.1916",
  //           pob: "Milwaukee, WI",
  //           children: [{ name: "Hannah" }, { name: "Benard Rosenburg" }],
  //         },
  //       ],
  //     },
  //     {
  ...
  //           dod: "1978",
  //           pod: "Cleveland, OH",
  //           children: [{ name: "Esther Green" }, { name: "Irviny Fried" }],
  //         },
  //         {
  //           name: "Ben Hershovitz",
  //           dob: "1889",
  //           dod: "1935",
  //           children: [{ name: "Ruth" }, { name: "Jacob Hershovitz" }],
  //         },
  //       ],
  //     },
  //   ],
